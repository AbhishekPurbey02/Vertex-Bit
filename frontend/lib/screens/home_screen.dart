...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(child: _buildProductCard('School Management System', 'Complete school ERP — attendance, exams, library, fees, and reporting in one platform.', 'Rs. 30,000', 'Rs. 40,000')),
                            const SizedBox(width: 24),
                            Expanded(child: _buildProductCard('Cooperative Management', 'Full cooperative management with accounting, member tracking, loan management, and audit reports.', 'Rs. 35,000', 'Rs. 40,000')),
                            const SizedBox(width: 24),
                            Expanded(child: _buildProductCard('Clinic Management', 'Streamline patient records, appointments, billing, prescriptions, and staff management.', 'Rs. 25,000', 'Rs. 25,000')),
                          ],
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(child: _buildTestimonialCard('"Safari Yatri Private Limited is highly satisfied with the digital solution provided. Their team delivered excellence."', 'Rajesh Koirala', 'CEO, Safari Yatri')),
                            const SizedBox(width: 24),
                            Expanded(child: _buildTestimonialCard('"Vertex Bit transformed our cooperative management. The software is intuitive and the support is outstanding."', 'Sita Sharma', 'Manager, Samaj Cooperative')),
                            const SizedBox(width: 24),
                            Expanded(child: _buildTestimonialCard('"Professional team, delivered ahead of schedule. Our school management has never been easier."', 'Ramesh Adhikari', 'Principal, Everest Academy')),
                          ],
                        ),
                      ],
                    ),
  ...
  Widget _buildProductCard(String title, String description, String price, String originalPrice) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(description, style: const TextStyle(color: Color(0xFF666666), height: 1.4, fontSize: 14)),
          const SizedBox(height: 16),
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    price,
                    style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF0F2B5B)),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(text, style: const TextStyle(color: Color(0xFF333333), height: 1.5, fontSize: 14)),
          const SizedBox(height: 16),
          const Divider(),
          const SizedBox(height: 8),
          Text(name, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1A1A1A))),
